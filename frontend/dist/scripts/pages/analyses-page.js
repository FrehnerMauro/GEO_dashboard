...
export class AnalysesPage {
    ...
    renderAnalysisDetail(runId, prompts, summary) {
        const analysisDetailSection = getElement("analysisDetailSection");
        if (!analysisDetailSection)
            return;
        let html = `
    ...
    show() {
        ...
        if (headerTitle)
            headerTitle.textContent = "Analyses";
...
window.analysesPage = new AnalysesPage();
//# sourceMappingURL=analyses-page.js.map